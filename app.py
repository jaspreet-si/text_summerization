...
tab_control.add(tab3, text=f'{"URL":^30s}')
tab_control.add(tab4, text=f'{"Comparison":^30s}')
tab_control.add(tab5, text=f'{"About ":^30s}')

label1 = Label(tab1, text='Summarization', padx=5, pady=5)
...
label3 = Label(tab4, text='Comprasion of summary', padx=5, pady=5)
...
def get_summary():
    ...
    # used fpr the lenght of the summary text in python
...
entry = Text(tab1, height=7)
entry.grid(row=2, column=0, columnspan=3, padx=5, pady=3)

# BUTTONS
button1 = Button(tab1, text="Reset", command=clear_text, width=12, bg='#03A9F4', fg='#fff')
button1.grid(row=4, column=0, padx=10, pady=10)

button2 = Button(tab1, text="Summarize", command=get_summary, width=12, bg='red', fg='white')
...
# About TAB
about_label = Label(tab5, text="Text summarization GUI V.0.0.1 ", pady=5, padx=5  )
